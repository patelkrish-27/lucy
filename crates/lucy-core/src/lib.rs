...
#[derive(Debug, Clone)]
pub struct ToolContext { pub session_id: SessionId, pub working_dir: Option<PathBuf>, pub execution_mode: ExecutionMode, pub events: mpsc::UnboundedSender<AgentEvent>, pub interrupt: InterruptSignal }
...
#[async_trait::async_trait]
pub trait ModelProvider: Send + Sync { async fn run(&self, prompt: &str, events: mpsc::UnboundedSender<AgentEvent>, interrupt: InterruptSignal) -> anyhow::Result<()>; }
